        ...
        <section className="w-full h-[600px] sm:h-[700px] md:h-[784px] bg-contactus text-white font-inter text-center overflow-hidden px-4">
          <div className="flex items-center justify-center text-center h-full">
            <h2 className="text-xl md:text-[70px] font-bold md:w-full">
              Have questions? We're always
              <span className="block md:block"> available to answer them</span>
            </h2>
          </div>
        </section>
          ...
          <div className="max-w-7xl w-full md:h-[618px] grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="bg-white flex-1 max-w-[488px]  p-6 rounded-xl shadow-md">
              <form className="space-y-4">
                ...
                {/* Email */}
                <div>
                  <label className="block fw-400 text-[18px]">
                    Email Address*
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  ...
                  <textarea className="w-full h-48 border border-gray-300 rounded-lg px-4 py-2 resize-none focus:outline-none"></textarea>
                </div>
            ...
            <div className="flex-2 mt-5 md:mt-0 items-center justify-center ">
              <div className="relative ">
                ...
                <div>
                  <img
                    src={`${BaseDirectories.CONTACT_US_DIR}/contact.png`}
                    alt="business woman"
        ...
        <div className="w-full bg-[#f7efff] px-6 py-16 flex justify-center">
          <div className="max-w-5xl w-full text-center">
            ...
            <p className="text-[#14142B] text-[18px] md:text-[20px] font-medium fw-600 max-w-5xl mx-auto ">
              Your satisfaction comes first! Our support team is available 24/7
              to help with any questions about Loadstone Finance and our
              services, including loans, investments, insurance, and more.
            </p>
